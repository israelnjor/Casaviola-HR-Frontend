...
const links = [
  ...
  { path: '/staff', label: 'Staff Directory', icon: '◈' },
...
const styles = {
  ...
  adminAvatar: { width: 34, height: 34, borderRadius: '50%', background: '#ede8f5', color: '#5c3d8f', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: 14 },
